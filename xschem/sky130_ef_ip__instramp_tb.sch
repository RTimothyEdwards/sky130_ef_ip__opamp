...
S {}
E {}
T {Instrumentation Amplifier as follower Testbench} 560 -1450 0 0 0.6 0.6 {}
...
N 880 -1220 880 -1140 {
lab=GND}
N 1260 -1240 1260 -1140 {
lab=GND}
N 1200 -1300 1200 -1180 {
lab=out}
N 850 -1180 1200 -1180 {
lab=out}
N 850 -1270 850 -1180 {
lab=out}
N 850 -1270 880 -1270 {
...
C {devices/ngspice_probe.sym} 640 -1330 0 0 {name=r3}
C {devices/title-2.sym} -700 -190 0 0 {name=l2 author="Tim Edwards" rev=1.0}
C {devices/code.sym} 560 -1080 0 0 {name=s1 only_toplevel=false value=".lib /usr/share/pdk/sky130A/libs.tech/combined/sky130.lib.spice tt"}
...
C {sky130_ef_ip__instramp.sym} 1030 -1270 0 0 {name=x1}
C {devices/vsource.sym} 780 -1170 0 0 {name=V3 value=3.3}
C {devices/gnd.sym} 740 -1140 0 0 {name=l4 lab=GND}
C {devices/lab_pin.sym} 780 -1240 0 0 {name=p2 sig_type=std_logic lab=ena}
